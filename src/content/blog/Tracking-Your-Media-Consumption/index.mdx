...
There's even more reasons though, in the modern age we're plagued with choices and personally I freeze up and can't decide at all if I have too many options, if I just tracked what shows I want to actually watch since before then I easily know what next to watch instead of spending hours scrolling Netflix only to put my comfort show on for the 100th time.
